...
public class ConsultaTableModel extends AbstractTableModel {
	...
	private static final int CODIGO = 0;
        	private static final int DATAAGENDAMENTO = 1;
	private static final int PRIORIDADE = 2;
	private static final int DATAABERTURA = 3;
	private static final int TITULO = 4;
	private static final int STATU = 5;//Inserida 22:54
	...
	public ConsultaTableModel(List<Chamado> valores) {
